package com.smms.session.controller.advice;

import com.smms.session.dto.response.ErrorResponse;
import com.smms.session.exception.SessionException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handle(SessionException ex) {
    ...
    public ResponseEntity<ErrorResponse> handleGeneric(Exception ex) {
        log.error("Unhandled exception in session-service", ex);
