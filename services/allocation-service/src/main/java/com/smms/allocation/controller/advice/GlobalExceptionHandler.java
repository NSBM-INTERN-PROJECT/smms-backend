package com.smms.allocation.controller.advice;

import com.smms.allocation.dto.response.ErrorResponse;
import com.smms.allocation.exception.AllocationException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleAllocation(AllocationException ex) {
    ...
    public ResponseEntity<ErrorResponse> handleArg(IllegalArgumentException ex) {
        return ResponseEntity.badRequest().body(ErrorResponse.builder()
                .error("INVALID_REQUEST").message(ex.getMessage())
                .status(HttpStatus.BAD_REQUEST.value()).build());
    }

    @ExceptionHandler(Exception.class)
    public ResponseEntity<ErrorResponse> handleGeneric(Exception ex) {
        log.error("Unhandled exception in allocation-service", ex);
